...
scriptname = "main"
compile_cmd = "g++ --std=c++17 " + scriptname + ".cpp -o dans_genenet -I../morphologica -I/usr/include/hdf5/serial -I/usr/include/jsoncpp -Wl,-rpath,/usr/lib/x86_64-linux-gnu/hdf5/serial /usr/lib/x86_64-linux-gnu/hdf5/serial/libhdf5.so -lpthread -lsz -lz -ldl -lm"
